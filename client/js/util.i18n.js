...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'help.what_is_nodecrypt': ' ',			'help.what_is_nodecrypt_desc': ' ',
			...
			'help.step_join': ' "',
			'help.step_join_desc': ' ',
			'help.security_features': ' ',			'help.e2e_encryption': ' ',
			'help.e2e_encryption_desc': ' ',
			'help.password_enhanced_encryption': ' ',
			'help.password_enhanced_encryption_desc': ' ',
			'help.no_history': ' ',
			'help.no_history_desc': ' ',
			'help.anonymous_communication': ' ',
			'help.anonymous_communication_desc': ' ',
			'help.decentralized': '🌐 Decentralized',
			'help.decentralized_desc': ' ',			'help.usage_tips': '💡 Usage Tips',
	...
	zh: {
		...
		translations: {
			...
			// Login and main UI
			'ui.enter_node': '进入新的room',
			'ui.username': '用户名',
			'ui.node_name': 'room名称',
			'ui.node_password': 'room密码',
			'ui.optional': '（可选）',
			'ui.enter': '确定',
			'ui.connecting': '连接中...',
			'ui.node_exists': '此room已存在',
			'ui.my_name': '我的名字',
			'ui.members': '在线成员',
			'ui.message': '消息',
			...
			'help.anonymous_communication_desc': '',
			'help.decentralized': '',
			'help.decentralized_desc': '',			'help.usage_tips': '',
			'help.important_note': '',
			'help.room_isolation_note': '',
			'help.tip_private_chat': '',
			'help.tip_private_chat_desc': '',
			'help.tip_group_chat': '',
			'help.tip_group_chat_desc': '',
			'help.tip_security_reminder': '',
			'help.tip_security_reminder_desc': '',
			'help.tip_password_strategy': '',
